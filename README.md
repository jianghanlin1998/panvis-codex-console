...
Workspace packages are under `packages/`. Deliberate public APIs are exported by package entry points. See `docs/S0A_SCOPE.md`, `docs/S0B1_SCOPE.md`, `docs/S0C_SCOPE.md`, and `docs/S0D_PROVIDER_NEUTRAL_EXECUTION.md` for the implemented boundaries.
