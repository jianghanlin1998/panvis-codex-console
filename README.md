...
Workspace packages are under `packages/`. Deliberate public APIs are exported by package entry points. See `docs/S0A_SCOPE.md`, `docs/S0B1_SCOPE.md`, `docs/S0B2A_CONTEXT_STORAGE.md`, `docs/S0B2B_DIGEST_AUDIT_STORAGE.md`, `docs/S0C_SCOPE.md`, `docs/S0D_PROVIDER_NEUTRAL_EXECUTION.md`, `docs/S1A_MATURITY_DEPENDENCY_READINESS.md`, `docs/S1B1_PERSISTED_READINESS_SNAPSHOT.md`, and `docs/S1B2A_IMPLEMENTATION_COMPLETION.md` for the implemented boundaries.
