...
export const PlanningProviderDiagnosticsSchema = z.object({
  protocolCheck: z.enum(["TOOL_ITEM_LIFECYCLE", "TOOL_OUTPUT_LIFECYCLE", "DYNAMIC_TOOL_REQUEST", "COMMAND_ITEM_SHAPE", "COMMAND_ACTION_SHAPE", "COMMAND_WORKING_DIRECTORY", "TURN_IDENTITY", "ITEM_STATUS", "AGENT_MESSAGE_PHASE", "AGENT_MESSAGE_LIFECYCLE", "TERMINAL_ORDER", "UNCLASSIFIED", "TOOL_WRITE_IN_READ_ONLY", "TOOL_DYNAMIC_NOT_CONFIGURED", "TOOL_MCP_NOT_CONFIGURED", "TOOL_AGENT_NOT_CONFIGURED", "TOOL_TYPE_UNKNOWN"]).optional(),
  failureCode: z.enum([
